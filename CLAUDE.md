...
| Skinport | n/a | Keyless documented API. Completed-sale price evidence + sourced exit fees + name-level acquisition reference on confirmations (no floats/listing IDs/purchase endpoint documented — operator buys manually); 8 req/5 min, Brotli required. Never execution truth. |
